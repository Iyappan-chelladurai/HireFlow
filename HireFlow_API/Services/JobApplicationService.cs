...
namespace HireFlow_API.Services
{
    ...
    public class JobApplicationService : IJobApplicationService
    {
        ...
        public async Task<JobApplicationDTO> SubmitApplicationAsync(JobApplicationDTO jobApplication)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(resumePath))
                    throw new InvalidOperationException("Resume path configuration is missing.");
                ...
                // Score candidate (uncomment when ready)
            ...
            catch (Exception ex)
            {
                ...
                if (!string.IsNullOrEmpty(jobApplication.ResumePath) && File.Exists(jobApplication.ResumePath))
        ...
        {
            return await _repository.GetCandidateResumeByInterviewId(interviewId);
        }
    }
}